...
call terser scripts/modernizr.min.js scripts/dayjs.min.js scripts/vue.min.js scripts/vue-router.min.js scripts/vuetify_1.5.4.min.js scripts/vue-resource.min.js -c -o scripts/scripts.min.js
